  ...
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-black via-gray-900 to-black flex items-center justify-center overflow-hidden">
      ...
      <nav className="absolute top-0 left-0 right-0 z-50 p-4 md:p-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 md:space-x-6">
            ...
            <button
              onClick={onCartClick}
              className="relative p-2 md:p-3 hover:bg-white/10 rounded-lg transition-colors touch-manipulation"
      ...
      <div className="relative z-10 text-center px-4 md:px-6 max-w-4xl mx-auto">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 md:mb-6 jakarta-light">
          Your Setup,
          <span className="text-[#F7DD0F] block">Perfected.</span>
        </h1>
        <p className="text-base sm:text-lg md:text-xl text-gray-300 mb-6 md:mb-8 max-w-2xl mx-auto jakarta-light px-4">
          Premium tech gear from Nepal. Mechanical keyboards, gaming mice, wireless headphones, and more.
        </p>
        <button 
          className="bg-[#F7DD0F] text-black px-6 md:px-8 py-3 md:py-4 rounded-lg font-semibold text-base md:text-lg hover:bg-[#F7DD0F]/90 transition-colors jakarta-light touch-manipulation"
